...
> [!WARNING]
> This deployment is considered legacy and is no longer supported as of v2.
> Go to the [new deployment guide](./deploy.md) for the latest recommended setup (it's much easier!)
>
> All source-code for the old deployment can be found under [github.com/simonwep/ocular-docker](https://github.com/simonwep/ocular-docker).
